...
type Handler interface {
	// HandleJoin is fired when a player joins the server. The uuid is the unique ID of the player that joined.
	HandleJoin(ctx *event.Context, uuid uuid.UUID)
...
func (NopHandler) HandleJoin(*event.Context, uuid.UUID)                                       {}
